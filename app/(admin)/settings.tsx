  ...
  return (
    <ScrollView style={[styles.container, { backgroundColor: colors.background }]}>
      ...
      <View style={[styles.section, { backgroundColor: colors.surface, borderColor: colors.border }]}>
        ...
        <View style={styles.profileRow}>
          <TouchableOpacity onPress={handlePickImage} style={styles.avatarWrapper}>
            {profilePhoto ? (
              ...
              <View style={[styles.avatarContainer, { backgroundColor: 'rgba(99, 102, 241, 0.1)' }]} >
                <Text style={[styles.avatarText, { color: '#ff6600' }]}>{initials}</Text>
              </View>
            )}
            <View style={[styles.cameraIcon, { backgroundColor: '#ff6600' }]} >
              {isUploadingPhoto ? (
          ...
          <View style={styles.profileInfo}>
            <Text style={[styles.profileName, { color: colors.text }]}>{user?.fullName || 'Admin'}</Text>
            ...
            <View style={[styles.roleBadge, { backgroundColor: 'rgba(99, 102, 241, 0.1)' }]} >
              <Text style={[styles.roleText, { color: '#ff6600' }]}>ADMIN</Text>
            </View>
          </View>
        </View>
        ...
        <TouchableOpacity style={[styles.saveButton, { backgroundColor: '#ff6600', opacity: isSaving ? 0.7 : 1 }]} onPress={handleSaveProfile} disabled={isSaving}>
      ...
      <View style={[styles.section, { backgroundColor: colors.surface, borderColor: colors.border }]}>
        <View style={styles.sectionHeader}>
          <Ionicons name="color-palette" size={20} color="#ff6600" />
          <Text style={[styles.sectionTitle, { color: colors.text }]}>Appearance</Text>
        </View>

        <View style={styles.themeRow}>
          <TouchableOpacity style={[styles.themeOption, !isDark && { borderColor: '#ff6600', backgroundColor: 'rgba(99, 102, 241, 0.1)' }]} onPress={() => setColorScheme('light')}>
            <Ionicons name="sunny" size={24} color={!isDark ? '#ff6600' : colors.textTertiary} />
            <Text style={[styles.themeLabel, { color: !isDark ? '#ff6600' : colors.text }]}>Light</Text>
          </TouchableOpacity>
          <TouchableOpacity style={[styles.themeOption, isDark && { borderColor: '#ff6600', backgroundColor: 'rgba(99, 102, 241, 0.1)' }]} onPress={() => setColorScheme('dark')}>
            <Ionicons name="moon" size={24} color={isDark ? '#ff6600' : colors.textTertiary} />
            <Text style={[styles.themeLabel, { color: isDark ? '#ff6600' : colors.text }]}>Dark</Text>
          </TouchableOpacity>
        </View>
      </View>
      ...
      <View style={[styles.section, { backgroundColor: colors.surface, borderColor: colors.border }]}>
        ...
        <View style={styles.switchRow}>
          ...
          <Switch value={accidentAlerts} onValueChange={setAccidentAlerts} trackColor={{ false: colors.border, true: '#ff6600' }} thumbColor="#fff" />
        </View>
        ...
        <View style={styles.switchRow}>
          ...
          <Switch value={smsNotifications} onValueChange={setSmsNotifications} trackColor={{ false: colors.border, true: '#ff6600' }} thumbColor="#fff" />
        </View>
        ...
        <View style={styles.switchRow}>
          ...
          <Switch value={locationTracking} onValueChange={setLocationTracking} trackColor={{ false: colors.border, true: '#ff6600' }} thumbColor="#fff" />
        </View>

        <TouchableOpacity style={[styles.outlineButton, { borderColor: '#ff6600' }]} onPress={handleSaveNotifications}>
          <Ionicons name="save-outline" size={18} color="#ff6600" />
          <Text style={[styles.outlineButtonText, { color: '#ff6600' }]}>Save Notifications</Text>
        </TouchableOpacity>
      </View>
      ...
      <View style={[styles.section, { backgroundColor: colors.surface, borderColor: colors.border }]}>
        <View style={styles.sectionHeader}>
          <Ionicons name="log-out" size={20} color="#ff6600" />
          <Text style={[styles.sectionTitle, { color: colors.text }]}>Session</Text>
        </View>
        <TouchableOpacity style={[styles.outlineButton, { borderColor: '#ff6600' }]} onPress={handleLogout}>
          <Ionicons name="log-out-outline" size={18} color="#ff6600" />
          <Text style={[styles.outlineButtonText, { color: '#ff6600' }]}>Logout</Text>
        </TouchableOpacity>
      </View>
