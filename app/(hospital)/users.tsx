...
import { hospitalAPI } from '../../src/services/api';
...
export default function HospitalUsersScreen() {
  ...
  const fetchUsers = async () => {
    try {
      const response = await hospitalAPI.getAllUsers();
            ...
            {selectedUser && (
              <>
                <View style={styles.modalUserHeader}>
                  <LinearGradient colors={['#ef4444', '#dc2626']} style={styles.modalAvatar}>
