...
export default function PoliceSettings() {
  ...
  const initials = user?.fullName?.split(' ').map((n) => n[0]).join('').toUpperCase().slice(0, 2) || 'P';
  ...
  return (
    <ScrollView style={[styles.container, { backgroundColor: colors.background }]}>
      ...
      <OnDutyToggle role="police" style={{ marginHorizontal: 16, marginBottom: 16 }} />
      ...
      <View style={[styles.section, { backgroundColor: colors.surface, borderColor: colors.border }]}>
        ...
        <View style={styles.profileRow}>
          <TouchableOpacity onPress={handlePickImage} style={styles.avatarWrapper}>
            {profilePhoto ? (
              ...
              <View style={[styles.avatarContainer, { backgroundColor: 'rgba(59, 130, 246, 0.1)' }]}>
                <Text style={[styles.avatarText, { color: '#3b82f6' }]}>{initials}</Text>
              </View>
            )}
            <View style={[styles.cameraIcon, { backgroundColor: '#3b82f6' }]}>
              {isUploadingPhoto ? (
          ...
          <View style={styles.profileInfo}>
            <Text style={[styles.profileName, { color: colors.text }]}>{user?.fullName || 'Police'}</Text>
            ...
            <View style={[styles.roleBadge, { backgroundColor: 'rgba(59, 130, 246, 0.1)' }]}>
              <Text style={[styles.roleText, { color: '#3b82f6' }]}>POLICE</Text>
            </View>
          </View>
        </View>
        ...
        <TouchableOpacity style={[styles.saveButton, { backgroundColor: '#3b82f6', opacity: isSaving ? 0.7 : 1 }]} onPress={handleSaveProfile} disabled={isSaving}>
      ...
      <View style={[styles.section, { backgroundColor: colors.surface, borderColor: colors.border }]}>
        ...
        <View style={styles.themeRow}>
          <TouchableOpacity style={[styles.themeOption, !isDark && { borderColor: '#3b82f6', backgroundColor: 'rgba(59, 130, 246, 0.1)' }]} onPress={() => setColorScheme('light')}>
            <Ionicons name="sunny" size={24} color={!isDark ? '#3b82f6' : colors.textTertiary} />
            <Text style={[styles.themeLabel, { color: !isDark ? '#3b82f6' : colors.text }]}>Light</Text>
          </TouchableOpacity>
          <TouchableOpacity style={[styles.themeOption, isDark && { borderColor: '#3b82f6', backgroundColor: 'rgba(59, 130, 246, 0.1)' }]} onPress={() => setColorScheme('dark')}>
            <Ionicons name="moon" size={24} color={isDark ? '#3b82f6' : colors.textTertiary} />
            <Text style={[styles.themeLabel, { color: isDark ? '#3b82f6' : colors.text }]}>Dark</Text>
          </TouchableOpacity>
        </View>
      </View>
      ...
      <View style={[styles.section, { backgroundColor: colors.surface, borderColor: colors.border }]}>
        ...
        <View style={styles.switchRow}>
          ...
          <Switch value={accidentAlerts} onValueChange={setAccidentAlerts} trackColor={{ false: colors.border, true: '#3b82f6' }} thumbColor="#fff" />
        </View>
        ...
        <View style={styles.switchRow}>
          ...
          <Switch value={smsNotifications} onValueChange={setSmsNotifications} trackColor={{ false: colors.border, true: '#3b82f6' }} thumbColor="#fff" />
        </View>
        ...
        <View style={styles.switchRow}>
          ...
          <Switch value={locationTracking} onValueChange={setLocationTracking} trackColor={{ false: colors.border, true: '#3b82f6' }} thumbColor="#fff" />
        </View>

        <TouchableOpacity style={[styles.outlineButton, { borderColor: '#3b82f6' }]} onPress={handleSaveNotifications}>
          <Ionicons name="save-outline" size={18} color="#3b82f6" />
          <Text style={[styles.outlineButtonText, { color: '#3b82f6' }]}>Save Notifications</Text>
        </TouchableOpacity>
      </View>
      ...
      <View style={[styles.section, { backgroundColor: colors.surface, borderColor: colors.border }]}>
        ...
        <TouchableOpacity style={[styles.outlineButton, { borderColor: '#3b82f6' }]} onPress={handleLogout}>
          <Ionicons name="log-out-outline" size={18} color="#3b82f6" />
          <Text style={[styles.outlineButtonText, { color: '#3b82f6' }]}>Logout</Text>
        </TouchableOpacity>
      </View>
